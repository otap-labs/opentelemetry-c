...
The implementation vtable shared by the API and SDK libraries is internal. It is not an
extension interface for applications or third-party SDK implementations.
