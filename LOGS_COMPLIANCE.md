...
| Environment configuration | Implemented | SDK disablement, resource/service variables, supported BLRP variables, and generic/signal-specific OTLP settings. The pinned synchronous processor cannot apply `OTEL_BLRP_EXPORT_TIMEOUT`; see `docs/ENVIRONMENT.md`. |
