...
acknowledge receipt when the configured private channel is monitored and will coordinate
disclosure based on severity and fix availability; no fixed response SLA is promised during
